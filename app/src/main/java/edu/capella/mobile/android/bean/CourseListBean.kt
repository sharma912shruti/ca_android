...
/**
 * CourseListBean.kt : Bean / Pojo class to store response of JSON received from API.
 *
...
) :Serializable
{
    ...
    data class NewCourseroomData(
        var courseDetails: Any? = null,
        var courseEnrollments:  List<CurrentCourseEnrollment?>? = null,
        var currentCourseEnrollments: List<CurrentCourseEnrollment?>? = null,
        var timeZoneVal: Int? = null,
        var toolInformationForGrades: Any? = null
    ) :Serializable{
        data class CurrentCourseEnrollment(
            var academicEngagementAlert: Any? = null,
            var announcementLink: Any? = null,
            var courseActivity: Any? = null,
            var courseAnnouncements: List<Any?>? = null,
            var courseAssignmentNotifications: List<Any?>? = null,
            var courseGradeStatusNotifications: Any? = null,
            var courseIdentifier: String? = null,
            var courseLink: Any? = null,
            var courseMessageCount: Any? = null,
