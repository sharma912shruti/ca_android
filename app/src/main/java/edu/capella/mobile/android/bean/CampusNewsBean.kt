...
/**
 * CampusNewsBean.kt : Bean / Pojo class to store response of JSON received from API.
 *
...
data class CampusNewsBean(
    ...
    data class NewsData(
        ...
        var financeNewsXmlString: Any,
        var generalNewsXmlString: Any,
        var inAppBrowserForAcademicPlan: Boolean,
        var mobileappLowerVersion: String,
        var newsItems: ArrayList<NewsItem>,
        var numberOfMonthsForNews: Int
    )
    ...
    data class NewsItem(
        ...
        var itemCreateDate: Int,
        var itemCreator: String,
        var itemDescription: String,
        var itemGuid: String,
        var itemLink: String,
        var itemPublishDate: Long,
