...
import kotlinx.android.synthetic.main.activity_unit_webview.*
 ...
 * @see WebView
 */
class UnitWebViewActivity : MenuActivity() /*BaseActivity()*/, View.OnClickListener, View.OnTouchListener ,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentChildView(R.layout.activity_unit_webview , true)
    ...
    private inner class InAppWebView : WebViewClient() {
        override fun shouldOverrideUrlLoading(    view: WebView,url: String  ): Boolean
        {
            ...
            if(result.type == WebView.HitTestResult.SRC_ANCHOR_TYPE)
            {
                ...
                val stickyWork  = StickyInfoGrabber(this@UnitWebViewActivity)
...
//    }
  ...
  /*  private inner class CommonWebViewClient : WebViewClient() {
    ...
    private fun initNetworkBroadcastReceiver() {
        ...
        ConnectivityReceiver.connectivityReceiverListener = this@UnitWebViewActivity
