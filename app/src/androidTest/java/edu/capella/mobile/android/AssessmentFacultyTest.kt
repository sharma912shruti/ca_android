...
class AssessmentFacultyTest {
    ...
    fun init() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.gradeAndStatusLayout)).perform(ViewActions.click())
    ...
    @Test
    fun check_title_is_AssessmentFaculty() {
        Thread.sleep(1000)

        Espresso.onView(withId(R.id.headerTxt))
            .check(matches(ViewMatchers.withText("Assessment Status")))
    }

    @Test
    fun click_on_view_grades_and_assessment() {
        Thread.sleep(1000)
        Espresso.onView(ViewMatchers.withId(R.id.view_grades_and_assessment)).perform(ViewActions.click())
    }
