...
import edu.capella.mobile.android.activity.ClassmatesActivity
 ...
 * @since :  3/21/2020
 */
class ClassMatesListAdapterTest{
    ...
    fun init() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.classmatesLayout))
    ...
    @Test
    fun check_course_list_adapter_is_non_null() {
        Thread.sleep(500)
        var activity = getCurrentActivity() as ClassmatesActivity

        Assert.assertNotEquals(activity.mateListAdapter , null)
    }
    ...
    fun check_item_list_is_non_null() {
        ...
        Assert.assertNotEquals(activity.mateListAdapter!!.items , null)
    }
    ...
    fun check_context_is_non_null() {
        ...
        Assert.assertNotEquals(activity.mateListAdapter!!.context , null)
    }
    ...
    fun check_item_listener_is_non_null() {
        ...
        Assert.assertNotEquals(activity.mateListAdapter!!.matesItemListener , null)
    }

    @Test
    fun check_picture_loader_is_non_null() {

        Thread.sleep(500)
        var activity = getCurrentActivity() as ClassmatesActivity

        Assert.assertNotEquals(activity.mateListAdapter!!.picLoader , null)
    }
