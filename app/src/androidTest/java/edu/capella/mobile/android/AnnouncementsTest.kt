...
class AnnouncementsTest {
    ...
    @Test
    fun check_announcementlist_non_null() {

        var activity = getCurrentActivity() as AnnouncementsActivity
        Assert.assertTrue(activity.getAnnouncementsListSize()>= 0)
