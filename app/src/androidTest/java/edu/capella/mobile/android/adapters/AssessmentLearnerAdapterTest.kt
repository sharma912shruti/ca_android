...
class AssessmentLearnerAdapterTest {
...
//        }
    ...
    fun check_assessment_list_adapter_is_non_null() {
        ...
        Assert.assertNotEquals(activity.assessmentAdapter , null)
    }
    ...
    fun check_item_list_is_non_null() {
        ...
        Assert.assertNotEquals(activity.assessmentAdapter!!.assessmentList , null)
    }
    ...
    fun check_context_is_non_null() {
        ...
        Assert.assertNotEquals(activity.assessmentAdapter!!.context , null)
    }
    ...
    fun check_item_listener_is_non_null() {
        ...
        Assert.assertNotEquals(activity.assessmentAdapter!!.listener , null)
    }
